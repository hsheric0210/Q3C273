...
namespace Ton618.Utilities
{
    internal static partial class ClientNatives
    {
        ...
        internal delegate IntPtr VirtualAllocExProc(IntPtr hProcess, IntPtr lpAddress, UIntPtr dwSize, AllocationType flAllocationType, MemoryProtection flProtect);
        internal static IntPtr VirtualAllocEx(IntPtr hProcess, IntPtr lpAddress, UIntPtr dwSize, AllocationType flAllocationType, MemoryProtection flProtect)
